...
export type ContentGetPayload<Args extends $SelectIncludeOmit<$Schema, "Content", true>, Options extends $ClientOptions<$Schema> = $ClientOptions<$Schema>> = $SimplifiedModelResult<$Schema, "Content", Options, Args>;
...
export type ImageGetPayload<Args extends $SelectIncludeOmit<$Schema, "Image", true>, Options extends $ClientOptions<$Schema> = $ClientOptions<$Schema>> = $SimplifiedModelResult<$Schema, "Image", Options, Args>;
...
export type VideoGetPayload<Args extends $SelectIncludeOmit<$Schema, "Video", true>, Options extends $ClientOptions<$Schema> = $ClientOptions<$Schema>> = $SimplifiedModelResult<$Schema, "Video", Options, Args>;
